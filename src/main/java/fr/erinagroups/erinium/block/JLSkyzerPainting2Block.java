...
public class JLSkyzerPainting2Block extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:jl_skyzer_painting_2")
	public static final Block block = null;

	public JLSkyzerPainting2Block(EriniumModElements instance) {
		super(instance, 592);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("jl_skyzer_painting_2");
		}
