...
public class EriniumLogoBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:erinium_logo")
	public static final Block block = null;

	public EriniumLogoBlock(EriniumModElements instance) {
		super(instance, 594);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(32, 0, 1, 0, 32, 0))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(-16, 0, 15, 16, 32, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(1, 0, -16, 0, 32, 16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(15, 0, 32, 16, 32, 0))
