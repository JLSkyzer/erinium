...
public class AmenineLogsBlock extends EriniumModElements.ModElement {
	...
	public AmenineLogsBlock(EriniumModElements instance) {
		super(instance, 263);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("amenine_logs"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("amenine_logs");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("§5Amenine Logs");
		}
