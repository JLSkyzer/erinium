...
public class CandyBarBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:candy_bar")
	public static final Block block = null;

	public CandyBarBlock(EriniumModElements instance) {
		super(instance, 137);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("candy_bar"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinium:candy_bar"), configuredFeature);
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("erinium:candy_biome").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SPEED, 100,
					Block.Properties.create(Material.PLANTS, MaterialColor.RED).doesNotBlockMovement().sound(SoundType.PLANT)
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(9, 0, 2, 3, 15, 10))
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == MoonStoneBlock.block || ground == Blocks.STONE || ground == Blocks.GRASS_BLOCK || ground == CandyGrassBlock.block
					|| ground == ChocolateDirtBlock.block || ground == Blocks.DIRT
