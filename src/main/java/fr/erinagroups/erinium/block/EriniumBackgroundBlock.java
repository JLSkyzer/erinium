...
public class EriniumBackgroundBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:erinium_background")
	public static final Block block = null;

	public EriniumBackgroundBlock(EriniumModElements instance) {
		super(instance, 593);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("erinium_background");
		}
