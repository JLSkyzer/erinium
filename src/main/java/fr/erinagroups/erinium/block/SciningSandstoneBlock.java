...
public class SciningSandstoneBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:scining_sandstone")
	public static final Block block = null;

	public SciningSandstoneBlock(EriniumModElements instance) {
		super(instance, 107);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("scining_sandstone");
		}
