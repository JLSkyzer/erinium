...
public class CopperOreBlock extends EriniumModElements.ModElement {
	...
	public CopperOreBlock(EriniumModElements instance) {
		super(instance, 86);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("erinium:copper_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinium:copper_ore"), configuredFeature);
		}
	}
