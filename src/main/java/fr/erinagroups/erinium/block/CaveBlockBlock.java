...
public class CaveBlockBlock extends EriniumModElements.ModElement {
	...
	public CaveBlockBlock(EriniumModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.GLASS).sound(SoundType.GLASS).hardnessAndResistance(0.3f, 1f).setLightLevel(s -> 0));
