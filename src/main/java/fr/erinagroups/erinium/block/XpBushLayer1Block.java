...
public class XpBushLayer1Block extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:xp_bush_layer_1")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			...
			setRegistryName("xp_bush_layer_1");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(XpBushLayer0Block.block));
		}
