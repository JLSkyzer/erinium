...
public class RedJungleDirtBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:red_jungle_dirt")
	public static final Block block = null;

	public RedJungleDirtBlock(EriniumModElements instance) {
		super(instance, 687);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("red_jungle_dirt");
		}
