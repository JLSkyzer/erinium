...
public class CandyStoneBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:candy_stone")
	public static final Block block = null;

	public CandyStoneBlock(EriniumModElements instance) {
		super(instance, 146);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CandyCobblestoneBlock.block));
		}
	}
}
