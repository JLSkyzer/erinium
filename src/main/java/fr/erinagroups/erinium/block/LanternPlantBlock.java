...
public class LanternPlantBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:lantern_plant")
	public static final Block block = null;

	public LanternPlantBlock(EriniumModElements instance) {
		super(instance, 681);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("lantern_plant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinium:lantern_plant"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(4, 0, 2, 15, 11, 15))
