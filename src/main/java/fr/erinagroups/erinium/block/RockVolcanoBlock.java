...
public class RockVolcanoBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:rock_volcano")
	public static final Block block = null;

	public RockVolcanoBlock(EriniumModElements instance) {
		super(instance, 745);
	}
