...
public class CandyLogsBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:candy_logs")
	public static final Block block = null;

	public CandyLogsBlock(EriniumModElements instance) {
		super(instance, 140);
	}
