...
public class IcyMushroomBlock extends EriniumModElements.ModElement {
	...
	public IcyMushroomBlock(EriniumModElements instance) {
		super(instance, 679);
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new BlockItem(block, new Item.Properties().group(EriniumItemsItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("icy_mushroom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinium:icy_mushroom"), configuredFeature);
		}
	}
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("erinium:icy_forest").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.HASTE, 100, Block.Properties.create(Material.PLANTS, MaterialColor.CYAN).doesNotBlockMovement().sound(SoundType.PLANT)
					.hardnessAndResistance(0f, 0f).setLightLevel(s -> 0));
			setRegistryName("icy_mushroom");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(12, 0, 2, 2, 8, 12))
