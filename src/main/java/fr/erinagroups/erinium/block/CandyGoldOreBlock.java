...
public class CandyGoldOreBlock extends EriniumModElements.ModElement {
	...
	public CandyGoldOreBlock(EriniumModElements instance) {
		super(instance, 93);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("candy_gold_ore");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("erinium:candy_gold_ore_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("candy_gold_ore"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("erinium:candy_gold_ore"), configuredFeature);
		}
	}
