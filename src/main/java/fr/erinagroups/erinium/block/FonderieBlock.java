...
public class FonderieBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:fonderie")
	public static final Block block = null;
	@ObjectHolder("erinium:fonderie")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public FonderieBlock(EriniumModElements instance) {
		super(instance, 313);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("fonderie"));
		}
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("fonderie");
		}
