...
public class ChocolateDirtBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:chocolate_dirt")
	public static final Block block = null;

	public ChocolateDirtBlock(EriniumModElements instance) {
		super(instance, 139);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("chocolate_dirt");
		}
