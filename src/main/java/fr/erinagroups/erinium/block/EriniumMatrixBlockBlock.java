...
public class EriniumMatrixBlockBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:erinium_matrix_block")
	public static final Block block = null;

	public EriniumMatrixBlockBlock(EriniumModElements instance) {
		super(instance, 631);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("erinium_matrix_block");
		}
