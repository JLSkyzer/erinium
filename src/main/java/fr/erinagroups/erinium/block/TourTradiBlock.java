...
public class TourTradiBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:tour_tradi")
	public static final Block block = null;

	public TourTradiBlock(EriniumModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(-16, 0, 16, 32, 28, -8))

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(32, 0, 0, -16, 28, 24))

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 0, 32, -8, 28, -16))

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(0, 0, -16, 24, 28, 32))
