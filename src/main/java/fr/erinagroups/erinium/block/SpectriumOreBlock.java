...
public class SpectriumOreBlock extends EriniumModElements.ModElement {
	...
	public SpectriumOreBlock(EriniumModElements instance) {
		super(instance, 226);
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SpectriumGemItem.block, (int) (2)));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("erinium:spectrium_ore_match"), () -> CustomRuleTest.codec);
