...
public class FraisageNumeriqueBlock extends EriniumModElements.ModElement {
	...
	public FraisageNumeriqueBlock(EriniumModElements instance) {
		super(instance, 312);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("fraisage_numerique");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			switch ((Direction) state.get(FACING)) {
				case SOUTH :
				default :
					return VoxelShapes.or(makeCuboidShape(-16, 0, 16, 32, 31, -15)

					)

							.withOffset(offset.x, offset.y, offset.z);
				case NORTH :
					return VoxelShapes.or(makeCuboidShape(32, 0, 0, -16, 31, 31)

					)

							.withOffset(offset.x, offset.y, offset.z);
				case EAST :
					return VoxelShapes.or(makeCuboidShape(16, 0, 32, -15, 31, -16)

					)

							.withOffset(offset.x, offset.y, offset.z);
				case WEST :
					return VoxelShapes.or(makeCuboidShape(0, 0, -16, 31, 31, 32)
