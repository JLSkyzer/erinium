...
public class FusionStationBetaBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:fusion_station_beta")
	public static final Block block = null;

	public FusionStationBetaBlock(EriniumModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("fusion_station_beta");
		}
