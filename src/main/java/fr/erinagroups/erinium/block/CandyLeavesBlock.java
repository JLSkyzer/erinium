...
import fr.erinagroups.erinium.procedures.CandyLeavesParticleSpawningConditionProcedure;
import fr.erinagroups.erinium.particle.CandyLeavesParticleParticle;
...
public class CandyLeavesBlock extends EriniumModElements.ModElement {
	...
	public CandyLeavesBlock(EriniumModElements instance) {
		super(instance, 141);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			if (CandyLeavesParticleSpawningConditionProcedure.executeProcedure(Stream
				...
				for (int l = 0; l < 1; ++l) {
					...
					world.addParticle(CandyLeavesParticleParticle.particle, d0, d1, d2, d3, d4, d5);
				}
		}
	}
}
