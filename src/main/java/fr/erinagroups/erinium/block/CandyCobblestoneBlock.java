...
public class CandyCobblestoneBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:candy_cobblestone")
	public static final Block block = null;

	public CandyCobblestoneBlock(EriniumModElements instance) {
		super(instance, 145);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("candy_cobblestone");
		}
