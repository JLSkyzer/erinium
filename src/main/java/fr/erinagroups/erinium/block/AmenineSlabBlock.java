...
public class AmenineSlabBlock extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:amenine_slab")
	public static final Block block = null;

	public AmenineSlabBlock(EriniumModElements instance) {
		super(instance, 302);
	}
