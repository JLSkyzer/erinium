...
public class GemXpItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:gem_xp")
	public static final Item block = null;

	public GemXpItem(EriniumModElements instance) {
		super(instance, 81);
	}
