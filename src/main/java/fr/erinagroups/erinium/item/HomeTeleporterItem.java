...
public class HomeTeleporterItem extends EriniumModElements.ModElement {
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7bSet your home with the Home Setter and do /gohome"));
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			HomeTeleporterClickOnBlockProcedure.executeProcedure(Stream
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			HomeTeleportInventoryTickProcedure.executeProcedure(
