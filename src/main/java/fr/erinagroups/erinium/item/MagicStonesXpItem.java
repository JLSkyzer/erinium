...
public class MagicStonesXpItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:magic_stones_xp")
	public static final Item block = null;

	public MagicStonesXpItem(EriniumModElements instance) {
		super(instance, 578);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_stones_xp");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			StonesXpRightClickProcedure.executeProcedure(
