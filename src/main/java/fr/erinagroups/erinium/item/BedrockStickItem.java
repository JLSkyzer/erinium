...
public class BedrockStickItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:bedrock_stick")
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("Remove bedrock on right click"));
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			BedrockStickRightclickedOnBlockProcedure.executeProcedure(Stream
