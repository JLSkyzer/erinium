...
public class AmenineLiquid2Item extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:amenine_liquid_2")
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack getContainerItem(ItemStack itemstack) {
			return new ItemStack(AmenineLiquid1Item.block);
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("\u00A7eLiquid : \u00A75Amenine \u00A7a(2 / 5)"));
		}
	}
}
