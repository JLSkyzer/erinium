...
import fr.erinagroups.erinium.procedures.StonesInvisibilityRightClickProcedure;
...
public class MagicStonesInvisibilityItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:magic_stones_invisibility")
	public static final Item block = null;

	public MagicStonesInvisibilityItem(EriniumModElements instance) {
		super(instance, 554);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_stones_invisibility");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			StonesInvisibilityRightClickProcedure.executeProcedure(Stream
