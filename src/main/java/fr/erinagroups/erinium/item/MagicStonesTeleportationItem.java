...
public class MagicStonesTeleportationItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:magic_stones_teleportation")
	public static final Item block = null;

	public MagicStonesTeleportationItem(EriniumModElements instance) {
		super(instance, 574);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_stones_teleportation");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			StonesTeleportRightClickProcedure.executeProcedure(Stream
