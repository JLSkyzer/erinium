...
public class MagicStonesDamageItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:magic_stones_damage")
	public static final Item block = null;

	public MagicStonesDamageItem(EriniumModElements instance) {
		super(instance, 577);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_stones_damage");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			StonesDamageRightClickProcedure.executeProcedure(Stream
