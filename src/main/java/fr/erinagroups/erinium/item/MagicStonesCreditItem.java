...
import fr.erinagroups.erinium.procedures.StoneCreditRightClickProcedure;
...
public class MagicStonesCreditItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:magic_stones_credit")
	public static final Item block = null;

	public MagicStonesCreditItem(EriniumModElements instance) {
		super(instance, 579);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_stones_credit");
		}
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			StoneCreditRightClickProcedure.executeProcedure(
