...
public class MagicStonesCreditItem extends Item {
	public MagicStonesCreditItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		StoneCreditRightClickProcedure.execute(entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		StoneCreditRightClickProcedure.execute(context.getPlayer(), context.getItemInHand());
