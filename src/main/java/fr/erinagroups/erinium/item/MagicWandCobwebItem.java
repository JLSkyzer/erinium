...
public class MagicWandCobwebItem extends EriniumModElements.ModElement {
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("magic_wand_cobweb");
		}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 6f, 0, 0);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			MagicWandCobwebProjectileHitsPlayerProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
