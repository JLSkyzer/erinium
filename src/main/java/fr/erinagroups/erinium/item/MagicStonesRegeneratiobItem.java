...
public class MagicStonesRegeneratiobItem extends Item {
	public MagicStonesRegeneratiobItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		StoneRegenerationRightClickProcedure.execute(entity, itemstack);
		return ar;
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		StoneRegenerationRightClickProcedure.execute(context.getPlayer(), context.getItemInHand());
