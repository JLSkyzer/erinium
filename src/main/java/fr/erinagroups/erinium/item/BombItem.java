...
import fr.erinagroups.erinium.entity.renderer.BombRenderer;
...
public class BombItem extends EriniumModElements.ModElement {
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(AdminZoneItemGroup.tab).maxDamage(100));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(House1BlockBlock.block);
		}
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			BombProjectileHitsBlockProcedure.executeProcedure(Stream
