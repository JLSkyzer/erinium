...
public class MagicStonesDebugItem extends EriniumModElements.ModElement {
	...
	public MagicStonesDebugItem(EriniumModElements instance) {
		super(instance, 550);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("magic_stones_debug");
		}
		...
		public boolean hasEffect(ItemStack itemstack) {
			...
			if (!(MagicStonesDebugMakeItemGlowProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("itemstack", itemstack))
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			MagicStonesDebugRightclickedProcedure.executeProcedure(
		...
		public void onCreated(ItemStack itemstack, World world, PlayerEntity entity) {
			...
			MagicStonesDebugItemIsCraftedsmeltedProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("itemstack", itemstack))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			MagicStonesDebugItemInInventoryTickProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("itemstack", itemstack))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
	}
}
