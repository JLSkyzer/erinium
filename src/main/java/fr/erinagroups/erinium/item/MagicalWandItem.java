...
import fr.erinagroups.erinium.procedures.MagicalWandRangedItemUsedProcedure;
import fr.erinagroups.erinium.procedures.MagicalWandProjectileHitsPlayerProcedure;
import fr.erinagroups.erinium.entity.renderer.MagicalWandRenderer;
import fr.erinagroups.erinium.EriniumModElements;

@EriniumModElements.ModElement.Tag
public class MagicalWandItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:magical_wand")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == MagicOrbItem.block);
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == MagicOrbItem.block) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(MagicOrbItem.block).isDamageable()) {
						...
						MagicalWandRangedItemUsedProcedure.executeProcedure(
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MagicOrbItem.block);
		}
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			MagicalWandProjectileHitsPlayerProcedure.executeProcedure(Stream
