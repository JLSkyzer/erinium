...
public class CobbleVoidItem extends EriniumModElements.ModElement {
	@ObjectHolder("erinium:cobble_void")
	...
	public static class ItemCustom extends Item {
		...
		public boolean hasEffect(ItemStack itemstack) {
			...
			if (!(CobbleVoidMakeItemGlowProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("itemstack", itemstack))
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			CobbleVoidItemInInventoryTickProcedure.executeProcedure(Stream
