...
import fr.erinagroups.erinium.network.TestGuiSlotMessage;
...
public class TestGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TestGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumModMenus.TEST_GUI.get(), id);
		...
		TestGuiThisGUIIsOpenedProcedure.execute(entity);
	}
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			EriniumMod.PACKET_HANDLER.sendToServer(new TestGuiSlotMessage(slotid, x, y, z, ctype, meta));
			TestGuiSlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
