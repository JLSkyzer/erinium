...
public class PresentationGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public PresentationGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EriniumModMenus.PRESENTATION_GUI.get(), id);
