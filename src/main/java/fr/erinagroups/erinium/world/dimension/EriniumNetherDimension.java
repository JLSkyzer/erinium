...
public class EriniumNetherDimension extends EriniumModElements.ModElement {
	public EriniumNetherDimension(EriniumModElements instance) {
		super(instance, 727);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("erinium:erinium_nether"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
