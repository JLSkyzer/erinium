...
public class FactionBetaDimension extends EriniumModElements.ModElement {
	public FactionBetaDimension(EriniumModElements instance) {
		super(instance, 662);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("erinium:faction_beta"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
