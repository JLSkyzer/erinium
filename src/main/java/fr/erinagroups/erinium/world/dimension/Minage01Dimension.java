...
public class Minage01Dimension extends EriniumModElements.ModElement {
	public Minage01Dimension(EriniumModElements instance) {
		super(instance, 664);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("erinium:minage_01"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
