...
public class OakDimensionDimension extends EriniumModElements.ModElement {
	public OakDimensionDimension(EriniumModElements instance) {
		super(instance, 786);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("erinium:oak_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
