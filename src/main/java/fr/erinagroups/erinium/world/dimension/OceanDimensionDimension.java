...
public class OceanDimensionDimension extends EriniumModElements.ModElement {
	public OceanDimensionDimension(EriniumModElements instance) {
		super(instance, 787);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("erinium:ocean_dimension"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
