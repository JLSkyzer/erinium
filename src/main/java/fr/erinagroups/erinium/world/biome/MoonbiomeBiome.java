...
public class MoonbiomeBiome extends EriniumModElements.ModElement {
	public static Biome biome;

	public MoonbiomeBiome(EriniumModElements instance) {
		super(instance, 597);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777216).setWaterColor(-12040120).setWaterFogColor(-8421505)
						.withSkyColor(-16777216).withFoliageColor(-12040120).withGrassColor(-12040120).build();
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
						Feature.DISK
								.withConfiguration(new SphereReplaceConfig(Blocks.GRAVEL.getDefaultState(), FeatureSpread.func_242253_a(2, 3), 2,
										ImmutableList.of(MoonSandBlock.block.getDefaultState(), MoonStoneBlock.block.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("erinium:moonbiome"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("moonbiome_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("moonbiome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("moonbiome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
