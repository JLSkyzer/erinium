...
public class ProfileMenuStatsGuiWindow extends ContainerScreen<ProfileMenuStatsGui.GuiContainerMod> {
	...
	private final static HashMap guistate = ProfileMenuStatsGui.guistate;

	public ProfileMenuStatsGuiWindow(ProfileMenuStatsGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("erinium:textures/screens/main_menu_cale.png"));
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Bienvenue : \u00A7e@p", 69, 4, -13382656);
		this.font.drawString(ms, "Serveur : \u00A7eMinage01", 69, 20, -1);
		this.font.drawString(ms, "Joueurs Connect\u00E9 : \u00A7e100 / 100", 69, 35, -1);
	}
