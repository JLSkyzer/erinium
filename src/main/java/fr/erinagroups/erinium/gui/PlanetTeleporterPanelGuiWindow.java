...
@OnlyIn(Dist.CLIENT)
public class PlanetTeleporterPanelGuiWindow extends ContainerScreen<PlanetTeleporterPanelGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = PlanetTeleporterPanelGui.guistate;

	public PlanetTeleporterPanelGuiWindow(PlanetTeleporterPanelGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
