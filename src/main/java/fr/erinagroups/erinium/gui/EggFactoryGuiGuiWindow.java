...
@OnlyIn(Dist.CLIENT)
public class EggFactoryGuiGuiWindow extends ContainerScreen<EggFactoryGuiGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = EggFactoryGuiGui.guistate;

	public EggFactoryGuiGuiWindow(EggFactoryGuiGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "error")) + "", 11, 53, -1);
	}
