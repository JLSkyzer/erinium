...
public class TestGuiScreen extends AbstractContainerScreen<TestGuiMenu> {
	...
	protected void renderBg(GuiGraphics guiGraphics, float partialTicks, int gx, int gy) {
		...
		guiGraphics.blit(new ResourceLocation("erinium:textures/screens/preset_gui.png"), this.leftPos + -5, this.topPos + -2, 0, 0, 427, 240, 427, 240);
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.erinium.test_gui.label_label_text"), 171, 47, -12829636, false);
	}
