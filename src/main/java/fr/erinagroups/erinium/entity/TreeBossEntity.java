...
import fr.erinagroups.erinium.entity.renderer.TreeBossRenderer;
...
public class TreeBossEntity extends EriniumModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 4f))
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737997, -10079488, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("tree_boss_spawn_egg"));
	}
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return TreeBossNaturalEntitySpawningConditionProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(5, new RandomWalkingGoal(this, 0.7));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(TreeBossShardItem.block));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			TreeBossEntityIsHurtProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			TreeBossOnEntityTickUpdateProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
