...
public class GomyEntity extends EriniumModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -6750208, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("gomy_spawn_egg"));
	}
	...
	public static class CustomEntity extends CowEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("By JLSkyzer"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Blocks.TNT));
		}
