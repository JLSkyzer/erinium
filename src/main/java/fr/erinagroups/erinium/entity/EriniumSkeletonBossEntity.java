...
public class EriniumSkeletonBossEntity extends EriniumModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -4586235, -15855083, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("erinium_skeleton_boss_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			this.setItemStackToSlot(EquipmentSlotType.HEAD, new ItemStack(EriniumArmorItem.helmet));
			this.setItemStackToSlot(EquipmentSlotType.CHEST, new ItemStack(EriniumArmorItem.body));
			this.setItemStackToSlot(EquipmentSlotType.LEGS, new ItemStack(EriniumArmorItem.legs));
			this.setItemStackToSlot(EquipmentSlotType.FEET, new ItemStack(EriniumArmorItem.boots));
		}
		...
		public void onDeath(DamageSource source) {
			...
			EriniumSkeletonBossEntityDiesProcedure.executeProcedure(Stream
