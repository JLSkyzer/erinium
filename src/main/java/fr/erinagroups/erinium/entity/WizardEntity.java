...
import fr.erinagroups.erinium.procedures.WizardEntityDiesProcedure;
import fr.erinagroups.erinium.item.MagicalWandItem;
import fr.erinagroups.erinium.entity.renderer.WizardRenderer;
...
public class WizardEntity extends EriniumModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16737793, -16763956, new Item.Properties().group(ItemGroup.MISC))
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setNoAI(false);
			enablePersistence();
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(MagicalWandItem.block));
		}
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(4, new MeleeAttackGoal(this, 0.25, false) {
				@Override
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ClassicLootboxBlock.block));
		}
		...
		public void onDeath(DamageSource source) {
			...
			WizardEntityDiesProcedure.executeProcedure(Stream
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			MagicalWandItem.shoot(this, target);
		}
