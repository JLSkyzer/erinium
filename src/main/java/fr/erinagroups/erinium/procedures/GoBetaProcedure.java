					...
					if (world != null) {
						...
						if (!(entity.getCapability(EriniumModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new EriniumModVariables.PlayerVariables())).vip) {
							if (List < EriniumModVariables.MapVariables.get(world).MaxPlayerPerServer) {
								...
								{
									Entity _ent = entity;
									_ent.teleportTo(EriniumModVariables.MapVariables.get(world).beta_x, EriniumModVariables.MapVariables.get(world).beta_y, EriniumModVariables.MapVariables.get(world).beta_z);
									if (_ent instanceof ServerPlayer _serverPlayer)
										_serverPlayer.connection.teleport(EriniumModVariables.MapVariables.get(world).beta_x, EriniumModVariables.MapVariables.get(world).beta_y, EriniumModVariables.MapVariables.get(world).beta_z, _ent.getYRot(),
												_ent.getXRot());
								}
							} else {
								if (entity instanceof Player _player && !_player.level().isClientSide())
