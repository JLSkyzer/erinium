					...
					if (world != null) {
						...
						if (!(entity.getCapability(EriniumModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new EriniumModVariables.PlayerVariables())).vip) {
							if (List < EriniumModVariables.MapVariables.get(world).MaxPlayerPerServer) {
								...
								{
									Entity _ent = entity;
									_ent.teleportTo(EriniumModVariables.MapVariables.get(world).minage03_x, EriniumModVariables.MapVariables.get(world).minage03_y, EriniumModVariables.MapVariables.get(world).minage03_z);
									if (_ent instanceof ServerPlayer _serverPlayer)
										_serverPlayer.connection.teleport(EriniumModVariables.MapVariables.get(world).minage03_x, EriniumModVariables.MapVariables.get(world).minage03_y, EriniumModVariables.MapVariables.get(world).minage03_z,
