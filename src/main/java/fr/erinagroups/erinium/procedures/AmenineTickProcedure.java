...
public class AmenineTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == AmenineLogsBlock.block) {
			if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == ExtractorBottleEmptyBlock.block) {
				if (!world.isRemote()) {
					BlockPos _bp = new BlockPos(x, y, z);
					TileEntity _tileEntity = world.getTileEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
					if (_tileEntity != null)
						_tileEntity.getTileData().putDouble("life", (new Object() {
						...
						}.getValue(world, new BlockPos(x, y, z), "life") + 1));
			...
			} else if ((world.getBlockState(new BlockPos(x, y, z))).getBlock() == ExtractorAmenine1Block.block) {
				if (!world.isRemote()) {
					BlockPos _bp = new BlockPos(x, y, z);
					TileEntity _tileEntity = world.getTileEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
