...
public class SciningCactusUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!((world.getBlockState(new BlockPos((int) x, (int) (y - 1), (int) z))).getBlock() == SciningCactusBlock.block)) {
			if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Blocks.AIR) {
				world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), SciningCactusBlock.block.getDefaultState(), 3);
			}
		} else {
			if (!((world.getBlockState(new BlockPos((int) x, (int) (y - 2), (int) z))).getBlock() == SciningCactusBlock.block)) {
				if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Blocks.AIR) {
					world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), SciningCactusBlock.block.getDefaultState(), 3);
				}
			}
