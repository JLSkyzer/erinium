...
public class GoCandyProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				EriniumMod.LOGGER.warn("Failed to load dependency entity for procedure GoCandy!");
			return;
		}
								...
								File.separator + "config.json");
						{
							try {
								...
								if ((entity.getCapability(EriniumModVariables.PLAYER_VARIABLES_CAPABILITY, null)
										.orElse(new EriniumModVariables.PlayerVariables())).playerLvl >= 10) {
									{
										...
										if (!_ent.world.isRemote && _ent instanceof ServerPlayerEntity) {
											RegistryKey<World> destinationType = RegistryKey.getOrCreateKey(Registry.WORLD_KEY,
													new ResourceLocation("erinium:candy_dimension"));
									...
									{
										Entity _ent = entity;
										_ent.setPositionAndUpdate(SecJsonObject.get("candy_x").getAsDouble(),
												SecJsonObject.get("candy_y").getAsDouble(), SecJsonObject.get("candy_z").getAsDouble());
										if (_ent instanceof ServerPlayerEntity) {
											((ServerPlayerEntity) _ent).connection.setPlayerLocation(SecJsonObject.get("candy_x").getAsDouble(),
													SecJsonObject.get("candy_y").getAsDouble(), SecJsonObject.get("candy_z").getAsDouble(),
