	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				EriniumMod.LOGGER.warn("Failed to load dependency world for procedure GemmeTake!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				EriniumMod.LOGGER.warn("Failed to load dependency x for procedure GemmeTake!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				EriniumMod.LOGGER.warn("Failed to load dependency y for procedure GemmeTake!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				EriniumMod.LOGGER.warn("Failed to load dependency z for procedure GemmeTake!");
			return;
		}
		if (dependencies.get("arguments") == null) {
			if (!dependencies.containsKey("arguments"))
				EriniumMod.LOGGER.warn("Failed to load dependency arguments for procedure GemmeTake!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				EriniumMod.LOGGER.warn("Failed to load dependency entity for procedure GemmeTake!");
			return;
		}
					...
					if (world instanceof ServerWorld) {
						((World) world).getServer().getCommandManager().handleCommand(
								...
								("tellraw " + entity.getDisplayName().getString() + " {\"text\":\"" + "\u00A7ale compte \u00A7e"
										+ StringArgumentType.getString(arguments, "uuid") + " \u00A7aa bien perdu \u00A76"
										+ Math.round(DoubleArgumentType.getDouble(arguments, "amount"))
										+ "\u00A7r\\uE007 \u00A7anouveau solde : \u00A76" + JsonObject1.get("gemme").getAsDouble() + "\u00A7r\\uE007"
										+ "\"}"));
					}
					EriniumMod.LOGGER.info(("[ERINIUM GEMS] take " + Math.round(DoubleArgumentType.getDouble(arguments, "amount")) + " to "
