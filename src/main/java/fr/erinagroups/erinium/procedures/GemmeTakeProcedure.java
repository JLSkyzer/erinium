				...
				try {
					...
					if (world instanceof ServerLevel _level)
						_level.getServer().getCommands().performPrefixedCommand(new CommandSourceStack(CommandSource.NULL, new Vec3(x, y, z), Vec2.ZERO, _level, 4, "", Component.literal(""), _level.getServer(), null).withSuppressedOutput(),
								("tellraw " + entity.getDisplayName().getString() + " {\"text\":\"" + "\u00A7ale compte \u00A7e" + StringArgumentType.getString(arguments, "uuid") + " \u00A7aa bien perdu \u00A76"
										+ Math.round(DoubleArgumentType.getDouble(arguments, "amount")) + "\u00A7r\\uE007 \u00A7anouveau solde : \u00A76" + JsonObject1.get("gemme").getAsDouble() + "\u00A7r\\uE007" + "\"}"));
					EriniumMod.LOGGER.info(("[ERINIUM GEMS] take " + Math.round(DoubleArgumentType.getDouble(arguments, "amount")) + " to " + StringArgumentType.getString(arguments, "uuid") + "'s account"));
					{
