...
public class FusionStationAlphaUpdateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((new Object() {
			...
			if ((new Object() {
				...
				if ((new Object() {
					...
					if (new Object() {
						...
						}.getItemStack(new BlockPos(x, y, z), (int) (0))).getOrCreateTag().getDouble("fortune"));
						temp2 = (new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
								TileEntity _ent = world.getTileEntity(pos);
						...
						(temp2).getOrCreateTag().putDouble("fortune", (temp + 1));
						{
							TileEntity _ent = world.getTileEntity(new BlockPos(x, y, z));
							if (_ent != null) {
								final int _sltid = (int) (2);
								final ItemStack _setstack = (temp2);
		...
		}.getItemStack(new BlockPos(x, y, z), (int) (1))).getItem() == SetanumBlockBlock.block.asItem()) {
			if (((new Object() {
				public ItemStack getItemStack(BlockPos pos, int sltid) {
					AtomicReference<ItemStack> _retval = new AtomicReference<>(ItemStack.EMPTY);
					TileEntity _ent = world.getTileEntity(pos);
			...
			}.getItemStack(new BlockPos(x, y, z), (int) (0)))).getDamage() > 0) {
				if (new Object() {
					public double getValue(IWorld world, BlockPos pos, String tag) {
						TileEntity tileEntity = world.getTileEntity(pos);
						if (tileEntity != null)
					...
					{
						ItemStack _ist = (temp2);
						if (_ist.attemptDamageItem((int) (-10000), new Random(), null)) {
							_ist.shrink(1);
							_ist.setDamage(0);
						}
					}
