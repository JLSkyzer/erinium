...
package fr.erinagroups.erinium.fluid.types;
...
public class HotWaterFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("erinium:block/hot_water_still"), FLOWING_TEXTURE = new ResourceLocation("erinium:block/hot_water_flow");
