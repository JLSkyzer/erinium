...
import fr.erinagroups.erinium.procedures.ProcedEriniumReloadVariablesProcedure;

import com.mojang.brigadier.builder.LiteralArgumentBuilder;
import com.mojang.brigadier.arguments.StringArgumentType;

@Mod.EventBusSubscriber
public class EriniumReloadVariablesCommand {
	@SubscribeEvent
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("eriniumreloadvariables")
				...
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(arguments -> {
					...
					ProcedEriniumReloadVariablesProcedure.executeProcedure(
