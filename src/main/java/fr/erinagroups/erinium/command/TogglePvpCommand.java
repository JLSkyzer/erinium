...
import fr.erinagroups.erinium.procedures.CmdTogglePvpProcedure;
...
public class TogglePvpCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("togglepvp")
				...
				.executes(arguments -> {
					...
					CmdTogglePvpProcedure.executeProcedure(
