...
public class BombPuissanceCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("bombpuissance").requires(s -> s.hasPermissionLevel(3))
				.then(Commands.argument("Value", DoubleArgumentType.doubleArg()).executes(arguments -> {
					...
					BombPuissanceProcedProcedure.executeProcedure(
