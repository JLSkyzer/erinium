...
import fr.erinagroups.erinium.procedures.ListplayerCmdProcedure;
...
public class ListplayerCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("listplayer")
				...
				.executes(arguments -> {
					...
					ListplayerCmdProcedure.executeProcedure(
